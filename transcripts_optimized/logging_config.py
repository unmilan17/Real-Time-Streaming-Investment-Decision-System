"""
Structured JSON logging configuration for transcripts pipeline.
...
def configure_worker_logging():
    """
    Initialize logging in a multiprocessing worker process.
    
    Call this at the start of functions executed by ProcessPoolExecutor
    to ensure each worker has properly configured logging.
    """
    configure_logging()
